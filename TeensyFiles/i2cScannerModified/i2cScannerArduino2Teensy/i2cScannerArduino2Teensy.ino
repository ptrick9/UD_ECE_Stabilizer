...
void loop()
{
    Serial.printf("ax: %d, ay: %d, az: %d, gx: %d, gy: %d, gz: %d\n", floatax, floatay, floataz, floatGx, floatGy, floatGz);
    delay(10);
...
double giveAccel(int16_t val, char axis) {
  ...
  Serial.print(compensated);*/
  Serial.printf("compensated: %d\n", compensated);
  double corrected = (roundf(1000 * (double(compensated))/asens) / 1000);
  Serial.printf("corrected: %f\n", corrected);
