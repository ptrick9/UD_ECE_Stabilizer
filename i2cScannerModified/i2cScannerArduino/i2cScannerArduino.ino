...
void loop()
{
    ...
    //3 is left motor
    if (control == 'p' || control == 'r') {
      //if (motorSet % 2 == 0) {
        float motorOutPitch = OutputPitch/100;
        float motorOutRoll = OutputRoll/100;
        analogWrite(4, 559 + 80 + 325 * motorOutRoll);
        analogWrite(3, 559 + 80 - 325 * motorOutRoll);
      //}
      //else {
        
        analogWrite(5, 562 + 40 + 325 * motorOutPitch);
        analogWrite(6, 566 + 40 - 325 * motorOutPitch);
      //}
